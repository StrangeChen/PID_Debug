...
QT_MOC_LITERAL(1, 8, 15), // "receive_success"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Receive\0receive_success\0"
};
...
static const uint qt_meta_data_Receive[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Float, QMetaType::Char,    2,    2,
...
void Receive::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receive_success((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< char(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Receive::*_t)(float , char );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Receive::receive_success)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Receive::receive_success(float _t1, char _t2)
{
